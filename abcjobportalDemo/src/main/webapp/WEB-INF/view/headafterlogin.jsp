    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarNav">
        <ul class="navbar-nav ms-auto me-0 me-lg-auto fw-semibold text-uppercase">
          ...
          <li class="nav-item me-0 me-lg-3">
            <a class="nav-link" href="searchUser"><i class="fa-solid fa-user-group"></i> People</a>
          </li>
          <li class="nav-item me-0 me-lg-3">
            <a class="nav-link" href="viewJobs"><i class="fa-solid fa-briefcase"></i> Jobs</a>
          </li>
           <li class="nav-item me-0 me-lg-3">
            <a class="nav-link" href="userProfile"><i class="fa-solid fa-user-group"></i> My profile</a>
          </li>
        </ul>
        <div class="nav-button d-flex flex-column flex-lg-row">
          <a href="login" class="btn btn-outline-secondary me-0 me-lg-3 mb-3 mb-lg-0">Logout</a>
